...
#	eventually
#   CSHARP_OUTPUT_NAME - file name (without extension) for the resulting assembly
#
...
if( CSHARP_TYPE MATCHES ".NET" )
  ...
  if(NOT DEFINED ${CSHARP_OUTPUT_DIR})
...
macro( CSHARP_ADD_PROJECT type name )
  ...
  if(DEFINED CSHARP_OUTPUT_NAME) 
	message("Setting actual name to " ${CSHARP_OUTPUT_NAME})
	set(ACTUAL_NAME ${CSHARP_OUTPUT_NAME})
  else()
	message("Defaulting actual name to " ${name})
    set(ACTUAL_NAME ${name})
  endif()
