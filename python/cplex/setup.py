...
setup(
    ...
    packages=["amplpy_cplex", "amplpy_cplex.__pyinstaller"],
     entry_points={
        "pyinstaller40": [
            "hook-dirs = amplpy_cplex.__pyinstaller:get_hook_dirs",
            "rthooks = amplpy_cplex.__pyinstaller:get_rthooks",
        ],
    },
    ext_modules=[
        Extension(
            ...
            sources=[
                os.path.join("amplpy_cplex", "swig", "amplpy_cplex_swig_wrap.cxx")
            ]
            + [
            ...
            + [
                ...
                for fname in ls_dir(
                    os.path.join("amplpy_cplex", "cpp", "cplex", "src")
                )
                if fname.endswith((".c", ".cpp"))
            ],
        )
